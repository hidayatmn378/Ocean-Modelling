...
chloro_value = ncread('selatmakassar.nc','chlorophyll');
...
% Read variable data from a NetCDF source
y0=ncread('selatmakassar.nc','latitude');
x0=ncread('selatmakassar.nc','longitude');
...
title('Chlorophyll-a Makassar Strait')
% print('gambar','-dpng')
