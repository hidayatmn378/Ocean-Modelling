...
u0=ncread('selatmakassar.nc','x_wind'); 
v0=ncread('selatmakassar.nc','y_wind'); 
lat=ncread('selatmakassar.nc','latitude'); 
lon=ncread('selatmakassar.nc','longitude'); 
...
xlabel('Longitude')
ylabel('Latitude')
title('Wind in February Makassar Strait')
